...
export default function DepartmentPage() {
  ...
  if (isLoading) return <p>학급 데이터를 불러오는 중 입니다.</p>;
  if (!department) return <p>학급 데이터를 찾을 수 없습니다.</p>;

  return (
    <Suspense fallback={<div>로딩 중...</div>}>
      <PageHeader title={department.name + '반'} />
      <section
      ...
      >
        ...
        {activeTab === 'staff' && <Staff department={department} mode="admin" />}
