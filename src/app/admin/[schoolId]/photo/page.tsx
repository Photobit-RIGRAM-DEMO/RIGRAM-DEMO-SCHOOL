...
export default function PhotoDepartmentListPage() {
  ...
  return (
    <section
      className="relative flex flex-col gap-4 w-full h-full bg-white rounded-xl p-5 md:p-6"
      aria-labelledby="department-photo-heading"
    >
      <h1 id="department-photo-heading" className="sr-only">
        사진 및 동영상 업로드 학급 페이지
      </h1>

      <header
        className="flex justify-between items-center"
        aria-label="사진 및 동영상을 추가할 학급 선택 안내"
      >
        <h2 className="text-20 font-semibold text-gray-900 md:text-24 md:font-bold">
          사진을 추가할 학급을 선택하세요.
        </h2>
      </header>
      <div
        className="grid grid-col-1 gap-4 overflow-y-auto scrollbar-hide md:max-h-[700px] md:grid-cols-3 md:gap-6"
        role="list"
      >
