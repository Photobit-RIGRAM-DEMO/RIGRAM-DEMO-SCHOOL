...
return (
    <div className="w-full flex flex-col items-center gap-8 px-4 md:px-10">
      ...
      {/* 실습사진 */}
      <StudentImage mediaTeam={media_team ?? []}
    ...
    />
      ...
      {/* 바텀 영역 */}
      <footer className="w-full max-w-[1600px] mx-auto bg-gray-100 border-t border-border py-6 flex justify-end px-4 rounded-md">
