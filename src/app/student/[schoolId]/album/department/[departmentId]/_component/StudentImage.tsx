...
const [modal, setModal] = useState<null | {
  ...
  return (
    <section className="w-full max-w-[1600px] bg-white border border-border rounded-md p-3 md:p-10 shadow-dropdown transition">
      <div className="flex flex-col gap-5">

        <ul className="grid grid-cols-1 gap-4">
          {mediaTeam.map((medium) => (
            <li key={medium.id}>
              <div className="flex items-stretch gap-2 sm:gap-4 mt-4">
                ...
                <div className="w-[100px] sm:w-4/12 sm:shrink-0 flex items-center">
                  <div className="grid grid-cols-3 gap-1 sm:gap-5 w-full">
                      ...
                      .map((member) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-[8px] sm:text-2xl mt-1 text-center">
                              {student.name}
                            </span>
                          </div>
                        );
       ...
       {modal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
                ...
                <div className="flex flex-col items-center sm:mr-50">
                <Image
