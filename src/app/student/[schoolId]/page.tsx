...
export default function AlbumPage() {
  ...
  return (
    <div className="w-full max-w-[640px] sm:max-w-[768px] md:max-w-[1024px] lg:max-w-[1280px] xl:max-w-[1600px] mx-auto flex flex-col gap-8">
      ...
      {/* 블록 1 */}
      <section className="w-full px-2 md:px-10 py-4 md:py-6">
        ...
        <div className="w-full mx-auto pb-4 relative">
          ...
          <div className="flex justify-center w-full">
            ...
            {/* 🔥 핵심: flex-row 고정 */}
            <div className="flex flex-row items-center justify-center gap-3 md:gap-4 w-full text-center">
      
              {/* 로고 */}
              <div className="relative w-[70px] sm:w-[90px] md:w-[156px] aspect-square flex items-center justify-center">
              ...
              {/* 텍스트 */}
              <h1 className="font-semibold text-gray-800 tracking-tight text-[12px] sm:text-[16px] md:text-[1.5rem] text-center leading-tight">
      ...
      <section className="relative w-full max-w-[1600px] mx-auto p-4 md:p-10">
       ...
       <div className="mt-20 columns-1 md:columns-2 gap-10 bg-white border border-border rounded-md p-5 md:p-10 shadow-dropdown transition">
          {histories?.map((history) => (
            <div key={history.id} className="mb-1 md:mb-3 break-inside-avoid">
